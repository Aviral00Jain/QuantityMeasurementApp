...
import com.placement.backendquantitymeasurement.BackendQuantityMeasurementApplication;
...
public class GlobalExceptionHandler {
    ...
    private final BackendQuantityMeasurementApplication application;

    GlobalExceptionHandler(BackendQuantityMeasurementApplication application) {
